...
from parsers.bmc_input_parser import BMCInputParser
from generators.diagram_generator import RefinedDiagramGenerator
...
def run_bmc_input_case():
    ...
    bmc_input_file = "config/bmc-input-specification.md"
