#!/usr/bin/env python3
"""
BMC AWS Architecture Diagram Generator - Simplified Version
...
def generate_main_architecture():
    ...
    with Diagram("BMC AWS Architecture - 60M Products Platform", 
        ...
        # Event flows
        invoice_service >> [sqs_fifo, sqs_standard, sns]
...
def generate_microservices_detail():
    ...
    with Diagram("BMC Microservices Architecture - ECS Fargate", 
        ...
        [product_task1, product_task2, product_task3] >> [rds, redis]
        [ocr_task1, ocr_task2] >> [s3, textract]
        
        # Event flows
        [invoice_task1, invoice_task2] >> sqs
